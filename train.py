...
def init_loss():
    ...
    # AMP_loss = AMPLoss().cuda()
    # PHA_loss = PhaLoss().cuda()
    return L1_loss,P_loss,E_loss,D_loss#, AMP_loss, PHA_loss
...
if __name__ == '__main__':  
    ...
    L1_loss,E_loss,D_loss, P_loss = init_loss()
    # L1_loss,P_loss,E_loss,D_loss, AMP_loss, PHA_loss = init_loss()
